<%-- 
    ...
    Created on : 16/05/2019, 4:10:37 PM
    Author     : francobuena
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container mt-lg-4 mt-sm-2 pb-4" style="width:100%; height:650px; background-color: white;">
               <div class="row">
                   <div class="col mt-5" style="text-align: center;">
                         <h2 > Your order is on processing </h2>
                   </div>
               </div> 
            <div class="row">
                <div class="col">
