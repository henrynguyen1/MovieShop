        ...
        <form>
            ...
            <tr class="table-warning">
                ...
                <tr>
                    ...
                    <td><%=shipment.getShipID()%> </td>
                    <td><%=shipment.getAddress()%> </td>
                    <td><%=shipment.getTrackingNo()%> </td>
                    <td><%=shipment.getUserID()%> </td>
                    <td><%=shipment.getType()%> </td>
                    ...
                    <td>
                        ...
                        <a href="/delete?id=<c:out value= '${shipments.shipID}'/>">Delete</a>                     
                    </td>
             
                    
                </tr>
                <tr colspan="2" align="center">
                    <a class="nav-link" href="add_shipment.jsp"> Add Shipment</button>
