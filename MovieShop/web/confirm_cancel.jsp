<%-- 
    Document   : confirm_cancel.jsp
    Created on : 30/05/2019, 9:40:27 PM
    Author     : yantoyanto
--%>
    ...
    <body>
        ...
        <div class="container mt-lg-4 mt-sm-2 pb-4" style="width:100%; height:650px; background-color: lightgray;">
            ...
            if (request.getParameter("updatedStatus") != null) {
                manager.updateOrder(order.getUserID(), status);
                Order orderCancel = manager.findOrder(order.getUserID());

                if (orderCancel != null) {
                    session.setAttribute("order", orderCancel);
                %>
