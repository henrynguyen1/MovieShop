         ...
         <div class="container-fluid" style="background-color: silver; height: 910px; width: 100%;">
          ...
          <div class="row" style="background-color: orange;  height: auto;">
            ...
            <table class="bg bg-transparent">
                <tr><td>MovieID:</td><td> 552413</td></tr>
                <tr><td>Title:</td><td> The Omen</td></tr>
                <tr><td>Genre:</td><td> Horror</td></tr>
                <tr><td>Duration:</td><td> 2:15:3</td></tr>
                <tr><td>Price:</td><td> 19.9</td></tr>
                <tr><td></td>
