<%-- 
    Document   : confirm_cancelShip
    Created on : 01-Jun-2019, 17:16:10
    Author     : henry117
--%>
    ...
    <div class="container mt-lg-4 mt-sm-2 pb-4" style="width:100%; height:650px; background-color: lightgray;">
               <div class="row" style="background-color: lightgray;">
                   <div class="col mt-5 pt-5" style="text-align: center;">
                       ...
                       <input type="hidden" value="updatedStatus" name="updatedStatus">
                        <input class="btn btn-danger" class="link" type="submit"  value=" Click here for make it cancel"  onclick="location.href = 'main.jsp'" />
                       </form>
                   </div>
               </div>  
            ...
            if (request.getParameter("updatedStatus") != null) {
                manager.updateShipment(shipment.getUserID(), status);
                Shipment ShipCancel = manager.findShipment(shipment.getUserID());

                if (ShipCancel  != null) {
                    session.setAttribute("shipment", ShipCancel );
                %>
                <p>Remove Successful</p>
                <%} else {%>
                <div class="row">
                    <div class="col" style="text-align: center;">
                <p>Your order has been canceled and Please click this link to go to <a href=main.jsp>main page</a>! Thank you!  </p>
                </div>
                </div>
                <%}%>
            <%}%>
