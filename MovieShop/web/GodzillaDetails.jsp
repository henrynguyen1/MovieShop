         ...
         <div class="container-fluid" style="background-color: silver; height: 910px; width: 100%;">
          ...
          <div class="row" style="background-color: orange;  height: auto;">
            ...
            <table class="bg bg-transparent">
                <tr><td>MovieID:</td><td> 554123</td></tr>
                <tr><td>Title:</td><td> Godzilla</td></tr>
                <tr><td>Genre:</td><td> Action</td></tr>
                <tr><td>Duration:</td><td> 1:50:6</td></tr>
                <tr><td>Price:</td><td> 22.0</td></tr>
                <tr><td></td>
