         ...
         <div class="container-fluid" style="background-color: silver; height: 910px; width: 100%;">
          ...
          <div class="row" style="background-color: orange;  height: auto;">
             ...
             <div class="row" style="align-content: center;">
                 ...
                 <div class="col-2 bg bg-white">
            <table class="bg bg-transparent">
                <tr><td>MovieID:</td><td> 552341</td></tr>
                <tr><td>Title:</td><td> The Mask</td></tr>
                <tr><td>Genre:</td><td> Comedy</td></tr>
                <tr><td>Duration:</td><td> 1:45:2</td></tr>
                <tr><td>Price:</td><td> 14.5</td></tr>
                <tr><td></td>
